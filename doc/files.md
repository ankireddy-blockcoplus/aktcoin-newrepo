...
* aktcoin.conf: contains configuration settings for aktcoind or aktcoin-qt
* aktcoind.pid: stores the process id of aktcoind while running
...
* debug.log: contains debug information and general logging generated by aktcoind or aktcoin-qt
