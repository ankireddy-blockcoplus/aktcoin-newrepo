# Support for Output Descriptors in Aktcoin Core

Since Aktcoin Core v0.17, there is support for Output Descriptors in the
...
on Aktcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Aktcoin Core wallets, a convenience function `combo` is
