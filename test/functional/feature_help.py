...
"""Verify that starting aktcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aktcoin with -h for help text")
        ...
        self.log.info("Start aktcoin with -version for version information")
        ...
        self.log.info("Start aktcoind with -fakearg to make sure it does not start")
