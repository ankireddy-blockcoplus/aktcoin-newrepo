...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aktcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aktcoin-tx [options] <hex-tx> [commands]  Update hex-encoded aktcoin transaction\n" +
            "or:     aktcoin-tx [options] -create [commands]   Create hex-encoded aktcoin transaction\n" +
            "\n";
