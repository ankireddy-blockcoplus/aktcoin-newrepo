...
const char * const BITCOIN_CONF_FILENAME = "aktcoin.conf";
const char * const BITCOIN_PID_FILENAME = "aktcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Aktcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Aktcoin";
#else
    // Unix
    return pathRet / ".aktcoin";
#endif
#endif
}
